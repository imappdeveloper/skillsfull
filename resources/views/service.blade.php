        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                ...
                <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    ...
                    <li class="breadcrumb-item active text-primary">{{$servicedata->service_name}}</li>
                </ol>
            </div>
        </div>
        <!-- Header End -->
                ...
                <div class="row g-5">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-item-content bg-white rounded p-5 h-100">
                            ...
                            <h1 class="display-4 mb-4">{{ $servicedata->service_name }}</h1>
                            <p>{{$servicedata->service_description ?? ' '}}
                            </p>
                            ...
                            <div class="h-100">
                            <div class="mb-5">
                                <h4 class="text-primary">Why perfer our {{$servicedata->service_name }}</h4>
                            ...
                            <div class="row g-4 justify-content-center">
                                <div class="col-12">
                                    <div class="rounded bg-light">
                                        <img src="{{ asset('storage/' . $servicedata->service_image) }}" class="img-fluid rounded w-100" alt="">
                                    </div>
                                </div>
