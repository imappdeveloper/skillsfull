                    ...
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="contact-img d-flex justify-content-center" >
                            <div class="contact-img-inner">
                                <img src="<?php echo e(asset('img/contact.png')); ?>" class="img-fluid w-100"  alt="Image">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Address</h4>
                                            <p class="mb-0"><?php echo e($setting->website_address); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Mail Us</h4>
                                            <p class="mb-0"><?php echo e($setting->website_email); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.6s">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Telephone</h4>
                                            <p class="mb-0"><?php echo e($setting->website_number); ?></p>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\SkillsFull\Skillsfull\resources\views/contact.blade.php ENDPATH**/ ?>