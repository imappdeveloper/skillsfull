                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-lg-5 animated fadeInRight">
                                <div class="calrousel-img" style="object-fit: cover;">
                                    <img src="<?php echo e(asset('img/banner1.png')); ?>" class="img-fluid w-100" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row gy-4 gy-lg-0 gx-0 gx-lg-5 align-items-center">
                            ...
                            <div class="col-lg-5 animated fadeInRight">
                                <div class="calrousel-img">
                                    <img src="<?php echo e(asset('img/banner2.png')); ?>" class="img-fluid w-100" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item p-4 pt-0">
                            <div class="feature-icon p-4 mb-4">
                                <i class="<?php echo e($feature->icon); ?> fa-3x"></i>
                            </div>
                            <h4 class="mb-4"><?php echo e($feature->feature_heading ?? ''); ?></h4>
                            <p class="mb-4"><?php echo e($feature->feature_description ?? ''); ?>
                ...
                <div class="row g-5">
                    <div class="col-xl-6 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="about-item-content bg-white rounded p-5 h-100">
                            ...
                            <h1 class="display-4 mb-4"><?php echo e($setting->about_us_heading); ?></h1>
                            <p>
                                <?php echo e($setting->about_us ?? ''); ?>
                            ...
                            <div class="row g-4 justify-content-center">
                                <div class="col-12">
                                    <div class="rounded bg-light">
                                        <img src="<?php echo e(asset('img/about-1.png')); ?>" class="img-fluid rounded w-100" alt="">
                                    </div>
                                </div>
                                <div class="col-sm-6">
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                ...
                <div class="row g-4 justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.<?php echo e($service->id+1); ?>s">
                        <div class="service-item">
                            <div class="service-img">
                                <img src="<?php echo e(asset('storage/' . $service->service_image)); ?>" class="img-fluid rounded-top w-100" alt="">
                            ...
                            <div class="service-content p-4">
                                <div class="service-content-inner">
                                    <a href="#" class="d-inline-block h4 mb-4"><?php echo e($service->service_name ?? ''); ?></a>
                                    <p class="mb-4"><?php echo e($service->service_description ?? ''); ?></p>
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
                    <div class="testimonial-item bg-light rounded">
                        <div class="row g-0">
                            <div class="col-4  col-lg-4 col-xl-3">
                                <div class="h-100">
                                    <img src="<?php echo e(asset('img/testimonial-1.jpg')); ?>" class="img-fluid h-100 rounded" style="object-fit: cover;" alt="">
                                </div>
                            </div>
                    ...
                    <div class="testimonial-item bg-light rounded">
                        <div class="row g-0">
                            <div class="col-4  col-lg-4 col-xl-3">
                                <div class="h-100">
                                    <img src="<?php echo e(asset('img/testimonial-2.jpg')); ?>" class="img-fluid h-100 rounded" style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-8 col-lg-8 col-xl-9">
                                <div class="d-flex flex-column my-auto text-start p-4">
                    ...
                    <div class="testimonial-item bg-light rounded">
                        <div class="row g-0">
                            <div class="col-4  col-lg-4 col-xl-3">
                                <div class="h-100">
                                    <img src="<?php echo e(asset('img/testimonial-3.jpg')); ?>" class="img-fluid h-100 rounded" style="object-fit: cover;" alt="">
                                </div>
                            </div>
                            <div class="col-8 col-lg-8 col-xl-9">
                                <div class="d-flex flex-column my-auto text-start p-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\SkillsFull\Skillsfull\resources\views/home.blade.php ENDPATH**/ ?>