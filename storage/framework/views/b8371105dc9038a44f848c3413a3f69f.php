                ...
                <div class="row g-5">
                            ...
                            <div class="row g-4 gx-5">
                                <div class="col-md-6 col-lg-6 col-xl-5">
                                    <div class="footer-item">
                                        <a href="index.html" class="p-0">
                                            <h3 class="text-white"><i class="fab fa-slack me-3"></i> SkillsFull</h3>
                                            <!-- <img src="img/logo.png" alt="Logo"> -->
                                        </a>
                                        <p class="text-white mb-4"><?php echo e($setting->footer_about ?? ' '); ?></p>
                                        <div class="footer-btn d-flex">
                                            <a class="btn btn-md-square rounded-circle me-3" target="_blank" href="<?php echo e($setting->website_fb ?? ''); ?>"><i class="fab fa-facebook-f"></i></a>
                                    
                                            <a class="btn btn-md-square rounded-circle me-3" target="_blank" href="<?php echo e($setting->website_insta ?? ''); ?>"><i class="fab fa-instagram"></i></a>
                                            <a class="btn btn-md-square rounded-circle me-0" target="_blank" href="<?php echo e($setting->website_in ?? ''); ?>"><i class="fab fa-linkedin-in"></i></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-3">
                                    <div class="footer-item">
                                        ...
                                        <a href="#"><i class="fas fa-angle-right me-2"></i>GKC Terminal</a>
                                        <a href="#"><i class="fas fa-angle-right me-2"></i>VyaruFood</a>
                                        <!--<a href="#"><i class="fas fa-angle-right me-2"></i>KrishiPath</a>-->
                                        <!--<a href="#"><i class="fas fa-angle-right me-2"></i>Simply Water</a>-->
                                        <!--<a href="https://www.dryhireequipment.com.au/"><i class="fas fa-angle-right me-2"></i>Dry Hire Equipment</a>-->
                                        <!--<a href="#"><i class="fas fa-angle-right me-2"></i> Refund Policy</a>-->
                    ...
                    <div class="col-xl-3">
                        <div class="footer-item">
                            ...
                            <p class="text-white mb-3"><?php echo e($setting->website_address ?? ''); ?></p>
                            ...
                            <div class="d-flex flex-shrink-0">
                                ...
                                <div class="d-flex flex-column ms-3 flex-shrink-0">
                                    ...
                                    <a href="tel:+ <?php echo e($setting->website_number); ?>"><span class="text-white">Free: + <?php echo e($setting->website_number ?? '+910000000'); ?></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-end mb-md-0">
                        <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Skillsfull Solution</a>, All right reserved.</span>
                    </div>
...
</html><?php /**PATH F:\SkillsFull\Skillsfull\resources\views/layouts/footer.blade.php ENDPATH**/ ?>