...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('admin/feature')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('admin/teams')); ?>">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('admin/training')); ?>">
          <i class="fas fa-fw fas fa-chalkboard"></i>
          <span>Training</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('admin/enquiries')); ?>">
          <i class="fas fa-fw fa fa-question-circle"></i>
          <span>Enquiries</span></a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('admin/topics')); ?>">
          <i class="fas fa-fw fa fa-question-circle"></i>
          <span>Topics</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo e(url('admin/setting')); ?>">Genral Settings</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <img class="img-profile rounded-circle" src="<?php echo e(asset('aimg/boy.png')); ?>" style="max-width: 60px">
        ...
        <!-- Topbar -->
<?php /**PATH F:\SkillsFull\Skillsfull\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>